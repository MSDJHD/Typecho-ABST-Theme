...
<div class="p-3" id="main" role="main">
    <article class="post" itemscope>
        ...
        <h1 class="display-5" itemprop="name headline">
            <a class="text-dark" style="text-decoration: none;" itemprop="url" href="<?php $this->permalink() ?>"><?php $this->title() ?></a>
        </h1>
        ...
        <hr />
        <br />
        <div class="post-content text-dark h6" itemprop="articleBody">
            <?php $this->content(); ?>
        </div>
    </article>
    <br />
